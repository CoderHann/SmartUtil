#
#  Be sure to run `pod spec lint SmartUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "CoderHann"
  # s.authors            = { "CoderHann" => "hyt163mail@163.com" }
  # s.social_media_url   = "http://twitter.com/CoderHann"
